...
Although the steps are identical to the ones I took above, it should be noted that the village income, $y_{vt}$ is calculated so that:
...
$$
where $y_{it}$ is income of a household $i$ and $N$ is the number of households in a village. 
This is because the first form is better fit to the theoretical model.
