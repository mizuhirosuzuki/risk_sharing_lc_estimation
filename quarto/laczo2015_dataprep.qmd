...
estimateVillagencomeTransitionProcessByVillage <- function(
  ...
  villageSimulatedLogIncMean <- villageSimulatedIncMean %>% log
  villageSimulatedLaggedLogIncMean <- colMeans(
    householdIncomeSimulationResult[
  ...
  villageAR1Parameters <- calculateAR1Parameters(
    villageSimulatedLogIncMean,
    villageSimulatedLaggedLogIncMean 
  )
  
  villageAR1TauchenApproximation <- approximateAR1Tauchen(
    numStatesVillage, villageSimulatedLogIncMean, 
    villageAR1Parameters$mu, villageAR1Parameters$rho, villageAR1Parameters$sigmau
  )
  
  villageLogIncomeGridPoints <- calculateGridPoints(numStatesVillage, villageSimulatedLogIncMean)
