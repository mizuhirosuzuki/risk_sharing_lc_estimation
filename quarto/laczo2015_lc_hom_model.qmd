...
calculateConsumption <- function(
  ...
  sigma
    ...
    # f = function(w) calculateMarginalUtility(
    #   aggregateIncome - w, 
    #   sigma
    #   ) - relativeParetoWeight * calculateMarginalUtility(w, sigma)
    # consumption = uniroot(
    #   f, 
    #   c(1e-5, aggregateIncome - 1e-5),
    #   tol = 1e-8,
    #   maxiter = 100
    #   )$root
    # return(consumption)
...
calculateDiffLCRiskSharingAndAutarky <- function(
  ...
  # f <- function(w) {(
  #   calculateMarginalUtility(aggregateIncome - w, sigma) 
  #   / calculateMarginalUtility(w, sigma) 
  #   - relativeParetoWeight
  # )}
  # householdConsumption <- uniroot(
  #   f, 
  #   c(1e-6, (aggregateIncome - 1e-6)), 
  #   tol = 1e-10, 
  #   maxiter = 300
  #   )$root
