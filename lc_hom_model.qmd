...
$$
  u(c_1(\underline{x}(s))) + \delta \sum_{s'} \pi(s' | s) V_1^{h-1}(s', \underline{x}(s)) = U_1^{aut}(s)
$$
and
$$
  u(c_2(\overline{x}(s))) + \delta \sum_{s'} \pi(s' | s) V_2^{h-1}(s', \overline{x}(s)) = U_2^{aut}(s),
$$
...
calculateValueLCRiskSharing <- function(
  ...
  #   if (
  #     householdValueLCRiskSharing[incomeStateIndex, 1] < householdAutarkyValue
  ...
  #           approx(
  #             relativeParetoWeightsGridPoints,
  #             householdValueLCRiskSharing[incomeStateIndex, ],
  #             x
  #           ) - householdAutarkyValue
  #         }, 
  ...
  #   
  #   if (
  #     villageValueLCRiskSharing[incomeStateIndex, numRelativeParetoWeights] < villageAutarkyValue
  #     # calculateDiffLCRiskSharingAndAutarky(
  ...
  #           approx(
  #             relativeParetoWeightsGridPoints,
  #             villageValueLCRiskSharing[incomeStateIndex, ],
  #             x
  #           ) - villageAutarkyValue
  #         },
  #         # function(x) {calculateDiffLCRiskSharingAndAutarky(
...
tmp$relativeParetoWeightBounds
